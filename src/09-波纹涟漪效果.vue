...
// 创建一个纹理
const texture = PIXI.Texture.from("https://pic.rmb.bdstatic.com/05b0ea405c9e690ab51627853a13de56.jpeg");
// 创建一个精灵
...
// 添加水波纹滤镜
const shockwaveFilter = new ShockwaveFilter([Math.random() * app.screen.width, Math.random() * app.screen.height], {
	radius: 100, //半径
	wavelength: 85, //波长
	amplitude: 55, //振幅
	speed: 300, //扩散速度
